		...
		foreach ($rels->Relationship as $rel) {
			switch ($rel["Type"]) {
				...
				case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument":
					...
					$xmlStrings = isset($xpath["Target"]) ? simplexml_load_string($this->_getFromZipArchive($zip, "$dir/$xpath[Target]")) : null;  //~ http://schemas.openxmlformats.org/spreadsheetml/2006/main");
					...
					$xmlStyles = isset($xpath["Target"]) ? simplexml_load_string($this->_getFromZipArchive($zip, "$dir/$xpath[Target]")) : null; //~ http://schemas.openxmlformats.org/spreadsheetml/2006/main");
					$numFmts = null;
