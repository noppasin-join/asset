...
<link rel="stylesheet" href="reg-style.css" />
				...
				function page_navigator2($before_p2,$plus_p2,$total2,$total_p2,$chk_page2,$d4,$choose_year,$choose_category,$choose_status,$txt_no,$txt_title,$choose_location,$g,$txt_use){
				...
				$lt_page=$total_p2-4;
				if($chk_page2>0){
				echo "<a  href='?s_page2=$pPrev&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&d4=1&&choose_year=$choose_year&&choose_category=$choose_category&&choose_status=$choose_status&&txt_no=$txt_no&&txt_title=$txt_title&&txt_use=$txt_use&&choose_location=$choose_location&&g=1' class='naviPN'><<</a>";
				}
				if($total_p2>=11){
				if($chk_page2>=4){
				echo "<a $nClass href='?s_page2=0&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&d4=1&&choose_year=$choose_year&&choose_category=$choose_category&&choose_status=$choose_status&&txt_no=$txt_no&&txt_title=$txt_title&&txt_use=$txt_use&&choose_location=$choose_location&&g=1'>1</a><a class='SpaceC'>. . .</a>";
				}
				if($chk_page2<4){
				for($i=0;$i<$total_p2;$i++){
				$nClass=($chk_page2==$i)?"class='selectPage'":"";
				if($i<=4){
				echo "<a $nClass href='?s_page2=$i&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&d4=1&&choose_year=$choose_year&&choose_category=$choose_category&&choose_status=$choose_status&&txt_no=$txt_no&&txt_title=$txt_title&&txt_use=$txt_use&&choose_location=$choose_location&&g=1'>".intval($i+1)."</a> ";
				}
				if($i==$total_p2-1 ){
				echo "<a class='SpaceC'>. . .</a><a $nClass href='?s_page2=$i&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&d4=1&&choose_year=$choose_year&&choose_category=$choose_category&&choose_status=$choose_status&&txt_no=$txt_no&&txt_title=$txt_title&&txt_use=$txt_use&&choose_location=$choose_location&&g=1'>".intval($i+1)."</a> ";
				}
				}
				}
				...
				echo "<a $nClass href='?s_page2=".intval($st_page+$i)."&&radiobutton=2&&d4=1&&choose_year=$choose_year&&choose_category=$choose_category&&choose_status=$choose_status&&txt_no=$txt_no&&txt_title=$txt_title&&txt_use=$txt_use&&choose_location=$choose_location&&g=1'>".intval($st_page+$i+1)."</a> ";
				}
				for($i=0;$i<$total_p2;$i++){
				if($i==$total_p2-1 ){
				$nClass=($chk_page2==$i)?"class='selectPage'":"";
				...
				echo "<a $nClass href='?s_page2=".intval($lt_page+$i-1)."&&radiobutton=2&&d4=1&&choose_year=$choose_year&&choose_category=$choose_category&&choose_status=$choose_status&&txt_no=$txt_no&&txt_title=$txt_title&&txt_use=$txt_use&&choose_location=$choose_location&&g=1'>".intval($lt_page+$i)."</a> ";
				}
				}
				}else{
				for($i=0;$i<$total_p2;$i++){
				$nClass=($chk_page2==$i)?"class='selectPage'":"";
				echo "<a href='?s_page2=$i&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&d4=1&&choose_year=$choose_year&&choose_category=$choose_category&&choose_status=$choose_status&&txt_no=$txt_no&&txt_title=$txt_title&&txt_use=$txt_use&&choose_location=$choose_location&&g=1' $nClass  >".intval($i+1)."</a> ";
				}
				}
				if($chk_page2<$total_p2-1){
				echo "<a href='?s_page2=$pNext&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&d4=1&&choose_year=$choose_year&&choose_category=$choose_category&&choose_status=$choose_status&&txt_no=$txt_no&&txt_title=$txt_title&&txt_use=$txt_use&&choose_location=$choose_location&&g=1'  class='naviPN'>>></a>";
				}
				}
				?>
              ...
              <div class="row">
                  ...
                  <div class="alert9 alert-info font_brown">
                    <form name="form_choose" method="post" action="data.php">
                      ...
                      <input type="hidden" name="txt_no" value="<?php echo $txt_no; ?>">
											...
											<input type="hidden" name="txt_use" value="<?php echo $txt_use; ?>">
                      ...
                      <?php } else { ?><select name="choose_status" onChange="submit();" style="font-size:13px;"><?php } ?>
										...
										<div class="pull-right hidden-1300">
											<a href="detail_barcode_list.php?choose_year=<?php echo $choose_year; ?>&choose_category=<?php echo $choose_category; ?>&choose_status=<?php echo $choose_status; ?>&choose_location=<?php echo $choose_location; ?>&txt_no=<?php echo $txt_no; ?>&txt_title=<?php echo $txt_title; ?>" target="_blank" >
											<button class="btn bg-sky4" type="button"><i class="fa fa-barcode"></i> </button>
											</a>
										</div>
										<?php
										$sql_qr="SELECT * FROM data_lda  where qrcode_check='1'";
										$qr_qr=ams_query($link,$sql_qr);
										$num_qr=mysqli_num_rows($qr_qr);
										?>
										<?php if($num_qr!="0") { ?>
										<div class="pull-right hidden-1200"> &nbsp;</div>
										<div class="pull-right hidden-1200">
											<a href="detail_qrcode_check.php" target="_blank" >
												<button class="btn bg-sky1" type="button"><i class="fa fa-qrcode bigger-130"></i> </button>
											</a>
										</div>
										<?php } ?>
										<div class="pull-right hidden-1200"> &nbsp;</div>
										<div class="pull-right hidden-1300">
											<a href="detail_qrcode_list.php?choose_year=<?php echo $choose_year; ?>&choose_category=<?php echo $choose_category; ?>&choose_status=<?php echo $choose_status; ?>&choose_location=<?php echo $choose_location; ?>&txt_no=<?php echo $txt_no; ?>&txt_title=<?php echo $txt_title; ?>" target="_blank" >
                ...
                <div class="row">
                    <div class="col-xs-12">
												...
												<button type="submit" class="btn bg-sky3"><i class="ace-icon fa fa-qrcode"></i> Search QRCode</button>
												</form>
												</div>


                      <div class="nav-search5  hidden-700" id="nav-search">
                      ...
                      <div class="nav-search6 hidden-800" id="nav-search">
                        <form class="form-search">
                          <span class="input-icon">
                          ...
                          <input type="hidden" name="choose_status" value="<?php echo $choose_status; ?>">
											...
											<div class="nav-search8 hidden-800" id="nav-search">
                        <form class="form-search">
                          <span class="input-icon">
                          <input type="text" placeholder="ผู้ใช้งาน ..." class="nav-search-input8"  autocomplete="off" name="txt_use" value="<?php echo $txt_use; ?>"  />
                          <i class="ace-icon fa fa-search nav-search-icon"></i> </span>
                          <input type="hidden" name="g" value="1">
                          <input type="hidden" name="d4" value="1">
                          <input type="hidden" name="choose_year" value="<?php echo $choose_year; ?>">
                  ...
                  <div class="row" style="padding:14px;"> </div>
								...
								if ($choose_year=="") {
														...
														} elseif ($txt_no!="" && $txt_title=="" && $txt_use=="") {
																							$var_trim=trim($txt_no);
																							$q=ams_sql("SELECT * FROM data_lda  where  barcode1 like ? order by barcode1", ["%$var_trim%"]);
														} elseif ($txt_no!="" && $txt_title!="" && $txt_use=="") {
																							$var_trim1=trim($txt_no);
																							$var_trim2=trim($txt_title);
																							$q=ams_sql("SELECT * FROM data_lda  where  barcode1 like ?  and lda_list like ? order by barcode1", ["%$var_trim1%", "%$var_trim2%"]);
														} elseif ($txt_no=="" && $txt_title!="" && $txt_use=="") {
																							$var_trim=trim($txt_title);
																							$q=ams_sql("SELECT * FROM data_lda  where  lda_list like ?  order by barcode1  ", ["%$var_trim%"]);
														} elseif ($txt_use!="") {
																							$var_trim=trim($txt_use);
																							$q=ams_sql("SELECT * FROM data_lda  where  name_use like ?  order by barcode1  ", ["%$var_trim%"]);
														}
                    ...
                    <div class="col-sm-12 col-xs-12">
                                    <div >
                                      <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                          <tr>
                                            <td class="head_blue" colspan="19"> :: ข้อมูลครุภัณฑ์</td>
                                          </tr>
                                          <tr>
                                            <th class="center font_brown70"> ลำดับ </th>
																						<th class="center font_brown70 hidden-800">Asset</th>
																						<th class="center font_brown70 hidden-800">เลขครุภัณฑ์(พัสดุ)</th>
																						<th class="center font_brown70 hidden-800">เลขครุภัณฑ์(LIB)</th>
                                            ...
                                            <th class="center font_brown70 hidden-800" colspan="4">View</th>
																						<?php if($level!="0") { ?>
																						<th class="center font_brown70 hidden-800">QR</th>
																						<?php } ?>
																						<th class="center font_brown70 hidden-800">สถานะยืม</th>
																						<?php if($level!="0") { ?>
																							<th class="center font_brown70 hidden-1200" colspan="3">Edit</th>
																					  <?php } ?>
                                          </tr>
                                        </thead>
                                        <tbody>
                                          ...
                                          <tr>
                                            <td class="center font_brown"><?php echo ($chk_page2*$e_page)+$i; ?>.</td>
																						<td class="center font_brown hidden-800"><?php if($rs['asset']!="") { echo $rs['asset']; } else { echo "-"; } ?></td>
																						<td class="center font_brown hidden-800"><?php echo $rs['barcode1']; ?></td>
																						<td class="center font_brown hidden-800"><?php if($rs['barcode3']!="") { echo $rs['barcode3']; } else { echo "-"; } ?></td>
                                            <td class="center font_brown hidden-1100"><?php echo $rs['lda_year']; ?></td>
																						<td class="font_brown">
																							...
																							<?php if($rs['file_img']!="") { ?>
																							<a  href="form_edit.php?id=<?php echo $rs['id']; ?>&d4=1&s_page2=<?php echo $s_page2;?>&urlquery_str2=<?php echo $urlquery_str2;?>&txt_title=<?php echo $txt_title_search;?>&txt_no=<?php echo $txt_no_search;?>"><?php echo $rs['lda_list']; ?></a>
																							<?php } else { echo $rs['lda_list']; } ?>
                                            ...
                                            <?php if ($rs['lda_status']=="1") { ?><td class="center" bgcolor="#49ac8b"><font color="#FFFFFF">ใช้งานปกติ</font> </td>
																					  ...
																					  <?php } elseif($rs['lda_status']=="6") { ?><td class="center" bgcolor="#d15b47"><font color="#FFFFFF">ส่งซ่อม</font></td>
																						<?php } elseif($rs['lda_status']=="7") { ?><td class="center" bgcolor="#d15b47"><font color="#FFFFFF">สภาพปกติ ไม่จำเป็นต้องใช้งาน</font></td>
																					  <?php } elseif($rs['lda_status']=="8") { ?><td class="center" bgcolor="#d15b47"><font color="#FFFFFF">รอจำหน่ายออก</font></td><?php } ?>
																						...
																						<td class="center hidden-800"><a  href="detail_qrcode.php?id=<?php echo $rs['id']; ?>" class="fancybox fancybox.ajax"><i class="ace-icon fa fa-qrcode bigger-130"></i></a></td>
																						<td class="center hidden-800">
																							<?php if($rs['file_img']!="" && $rs['file_img']!="-") { ?>
																							<a  href="detail_data_pic.php?id=<?php echo $rs['id']; ?>" class="fancybox fancybox.ajax"><i class="ace-icon fa fa-picture-o bigger-130"></i></a>
																							<?php } else { echo "-"; }?>
																						</td>

																						<td class="center hidden-800">
																							<?php if($rs['file_att']!="" && $rs['file_att']!="-") { ?>
																							<a  href="file_att/<?php echo $rs['year_budget'];?>/<?php echo $rs['file_att'];?>" target="_blank"> <i class="ace-icon fa fa-tag bigger-130"></i></a>
																						<?php } else { echo "-"; }?>
																						</td>
																						<?php if($level!="0") { ?>
																						<td class="center hidden-800">
																							<?php if($rs['qrcode_check']!="") { ?>
																							<a  href="qrcode_manage.php?id=<?php echo $rs['id']; ?>&s_page2=<?php echo $s_page2;?>&urlquery_str2=<?php echo $urlquery_str2; ?>&txt_title_search=<?php echo $txt_title; ?>&txt_no_search=<?php echo $txt_no; ?>&choose_category=<?php echo $choose_category?>&choose_status=<?php echo $choose_status?>&choose_location=<?php echo $choose_location?>" target="_parent"> <i class="ace-icon fa fa-check bigger-100 green"></i></a>
																						<?php } else { ?>
																							<a  href="qrcode_manage.php?id=<?php echo $rs['id']; ?>&s_page2=<?php echo $s_page2;?>&urlquery_str2=<?php echo $urlquery_str2; ?>&txt_title_search=<?php echo $txt_title; ?>&txt_no_search=<?php echo $txt_no; ?>&choose_category=<?php echo $choose_category?>&choose_status=<?php echo $choose_status?>&choose_location=<?php echo $choose_location?>&c=1" target="_parent"> <i class="ace-icon fa fa-check bigger-100"></i></a>
																							<?php } ?>
																						</td>
																						<?php } ?>

																							<?php if($rs['status_borrow']=="1") { ?><td class="center hidden-800" bgcolor="#49ac8b"><font color="#FFFFFF">เปิด</font>
																							<?php } elseif($rs['status_borrow']=="2") { ?><td class="center hidden-800" bgcolor="#d15b47"><font color="#FFFFFF">ปิด</font><?php } ?>


																						<?php if($level!="0") { ?>
																							<td class="center hidden-1200"> <a class="green" href="form_edit.php?id=<?php echo $rs['id']; ?>&s_page2=<?php echo $s_page2;?>&urlquery_str2=<?php echo $urlquery_str2; ?>&txt_title_search=<?php echo $txt_title; ?>&txt_no_search=<?php echo $txt_no; ?>&d4=1"><i class="ace-icon fa fa-pencil bigger-130"></i></a></td>
																							<td class="center hidden-1200"> <a class="green" href="form_delete.php?id=<?php echo $rs['id']; ?>&s_page2=<?php echo $s_page2;?>&urlquery_str2=<?php echo $urlquery_str2; ?>
																								&txt_title_search=<?php echo $txt_title; ?>&txt_no_search=<?php echo $txt_no; ?>&d4=1" onClick="return Conf<?php echo $id_cat; ?>(this)"><i class="ace-icon fa fa-trash-o bigger-130 red"></i></a></td>
																							<td class="center hidden-1200"> <a class="green" href="form_dup.php?id=<?php echo $rs['id']; ?>&s_page2=<?php echo $s_page2;?>&urlquery_str2=<?php echo $urlquery_str2; ?>
																								&txt_title_search=<?php echo $txt_title; ?>&txt_no_search=<?php echo $txt_no; ?>&d4=1"><i class="ace-icon fa fa-copy bigger-130 blue"></i></a></td>
																					  <?php } ?>
                                          </tr>
                                          ...
                                          <?php } ?>
																			...
																			<script language="JavaScript">
																																					function Conf<?php echo $id_cat; ?>(object) {
																	...
																	<?php   if ($total2 == 0 || $total_p2 == "1")  {  } else {  ?>
																		<div class="pull-right pagination9">
																			<li>
																				<?php page_navigator2($before_p2,$plus_p2,$total2,$total_p2,$chk_page2,$d4,$choose_year,$choose_category,$choose_status,$txt_no,$txt_title,$choose_location,$g,$txt_use); ?>
																			</li>
																		</div>
																	<?php } ?>
