...
?>
              ...
              ปีงบประมาณ :&nbsp;&nbsp;<font class="under_line_blue">&nbsp;&nbsp;<?php if($choose_year=="") { echo $year_budget; } else { echo $choose_year; } ?>&nbsp;&nbsp;</font>
                ...
                <div id="non-printable" class="pull-right">ดาวโหลดรายงานในรูปแบบ <a href="mypdf/report_data.pdf" target="_blank">PDF</a> , <a href="export_compare.php?choose_year=<?php echo $choose_year;?>" target="_blank">Excel</a></div>
