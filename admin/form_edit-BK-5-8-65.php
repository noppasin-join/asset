                    ...
                    <div class="row">
                      <div class="col-xs-7 col-sm-4">
                        <div class="input-group"> <span class="input-group-addon" style="background-color:#eeeeee;"><i class="ace-icon fa fa-bars"></i></span>
                          ...
                          placeholder="เลขครุภัณฑ์ ..." autocomplete="off" onKeyPress="checknumber()" value="<?php echo $barcode2; ?>">
                        </div>
										...
										<div class="row">
											<div class="col-xs-12 col-sm-4 font_brown">
												<div class="input-group"> <span class="input-group-addon" style="background-color:#eeeeee;"><i class="ace-icon fa fa-key"></i></span>
													<input type="text" class="form-control-mdf validate[required]"  name="txt_asset" placeholder="เลข Aseet ส่วนพัสดุ"
        ...
        <!-- /.col -->
			...
			<script type="text/javascript">
				jQuery(function($) {
					...
					$.mask.definitions['~']='[+-]';
					$('.input-mask-date').mask('9999-999-999-99-999');
