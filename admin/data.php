              ...
              <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12">
												...
												<button type="submit" class="btn bg-sky3"><i class="ace-icon fa fa-qrcode"></i> Search QR Code</button>
												</form>
												</div>
                    ...
                    <div class="col-sm-12 col-xs-12">
                                    <div >
                                      <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                          <tr>
                                            <td class="head_blue" colspan="18"> :: ข้อมูลครุภัณฑ์</td>
                                          </tr>
                                          <tr>
                                        ...
                                        <tbody>
                                          ...
                                          <?php } else { ?>
                                          <tr>
                                            <td class="center font_brown" colspan="18"><< ไม่มีข้อมูล >></td>
                                          </tr>
                                          <?php } ?>
                                        </tbody>
                                      </table>
