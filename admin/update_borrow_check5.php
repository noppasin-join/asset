...
if($amount>1) {
		...
		if($num_check2==0) {
			...
			$sql_data1=ams_sql("insert into data_take_list_more(year_budget,id_data_take,id_data_lda,id_data_take_list,id_category,id_category,for_month,barcode,status_return) values
