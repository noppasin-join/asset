				...
				<div class="main-content">
	                ...
	                <?php if($total_check>"0") { ?>
									<div class="alert alert-block alert-danger" id="success-alert">
										...
										<b class="dark"><u>พบข้อผิดพลาด</u></b>  &nbsp;&nbsp;หมวดหมู่ดังกล่าว มีในระบบแล้ว!
									</div>
									<?php } ?>
	                                <?php if($v_success=="1") { ?>
									<div class="alert alert-block alert-success" id="success-alert">
										...
										<strong>เพิ่มหมวดหมู่เรียบร้อย</strong>
									</div>
	                                <?php } ?>
	                                <?php if($v_del=="1") { ?>
									<div class="alert alert-block alert-success" id="success-alert">
										...
										<strong>ลบหมวดหมู่เรียบร้อย</strong>
									</div>
	                                <?php } ?>
	                            ...
	                            <div class="col-sm-6 col-xs-10">
	                                  <div >
	                                    <table class="table table-striped table-bordered table-hover">
	                                      <thead>
	                                        <tr>
	                                          <td class="head_blue" colspan="3"> :: ข้อมูลหมวดหมู่</td>
	                                        </tr>
	                                        <tr>
	                                          <td class="center "><b> ลำดับ. </b></td>
	                                          <td class="center"><b>ชื่อหมวดหมู่ </b></td>
																						<?php if($level!=0) { ?>
	                                          <td class="center"> </td>
																					  <?php } ?>
	                                        </tr>
	                                      ...
	                                      <tbody>
	                                        ...
	                                        <tr>
	                                          ...
	                                          <td class="font_brown"><?php echo $name_category; ?></td>

																						<?php if($level!=0) { ?>
	                                          <td class="center"><a class="red" href="add_category.php?id_del=<?php echo $id_cat;?>&send_del=1" onClick="return Conf<?php echo $id_cat; ?>(this)">
	                        		...
	                        		<form class="form-horizontal" role="form" method="post" name="frmMain" id="popup-validation" action="add_category.php">
	                                              ...
	                                              <div>
	                                                <div class="input-group"> <span class="input-group-addon">
	                                                  <i class="ace-icon fa fa-calendar"> </i> </span>
																										<?php if($level==0) { ?>
	                                                  <input class="col-xs-12 col-sm-12" type="text"  name="txt_category" placeholder="ชื่อหมวดหมู่" style="font-size:13px;background-color:#f8f0f2 !important;height:34px;" disabled/ >
																									<?php } else { ?>
																										<input class="col-xs-12 col-sm-12  validate[required]" type="text"  name="txt_category" placeholder="ชื่อหมวดหมู่"/>
																									<?php } ?>
	                                                </div>
	                                              </div>
	                                              <hr />
