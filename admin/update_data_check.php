...
$urlquery_str2=$_POST['urlquery_str2'] ?? '';
	...
	if($var_trim!="") {
		...
		echo "<SCRIPT LANGUAGE='JavaScript'>alert('บันทึกข้อมูล เรียบร้อย! ')</script>";
		echo "<meta http-equiv=\"Refresh\" content=\"0; URL=data_check_qrcode.php?q1=1&choose_location=$choose_location&s_page2=$s_page2&urlquery_str2=$urlquery_str2&g=1\">";
	}
