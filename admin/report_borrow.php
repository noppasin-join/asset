          ...
          <div class="main-content-inner">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
              ...
              <ul class="breadcrumb">
                ...
                <li class="active">รายงานยืมวัสดุ/ครุภัณฑ์</li>
              </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                  <div class="alert9 alert-info font_brown">
                    <form name="form_choose" method="post" action="report_borrow.php">
                      <input type="hidden" name="j31" value="1">
		        					 ...
		        					 ?>
											...
											<?php if($level!="0") {?>
												<div class="pull-right hidden-800">
													<a href="export_report_borrow.php?choose_year=<?php echo $choose_year; ?>" target="_blank" >
...
<tr>
	...
	<td class="center font_brown" bgcolor="#eef5f6">
		<?php if($num_10!="0") { ?>
			<a href="report_borrow_view.php?for_month=10&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_10 ) ; ?></a>
		<?php } else { echo "-"; } ?>
	</td>
	<td class="center font_brown" bgcolor="#eef5f6">
		<?php if($num_11!="0") { ?>
			<a href="report_borrow_view.php?for_month=11&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_11 ) ; ?></a>
		<?php } else { echo "-"; } ?>
	</td>
	<td class="center font_brown" bgcolor="#eef5f6">
		<?php if($num_12!="0") { ?>
			<a href="report_borrow_view.php?for_month=12&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_12 ) ; ?></a>
		<?php } else { echo "-"; } ?>
	</td>
...
<!-- period 2 -->
	<td class="center font_brown" bgcolor="#eff6ee">
		<?php if($num_1!="0") { ?>
			<a href="report_borrow_view.php?for_month=01&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_1 ) ; ?></a>
		<?php } else { echo "-"; } ?>
	</td>
	<td class="center font_brown" bgcolor="#eff6ee">
		<?php if($num_2!="0") { ?>
			<a href="report_borrow_view.php?for_month=02&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_2 ) ; ?></a>
		<?php } else { echo "-"; } ?>
	</td>
	<td class="center font_brown" bgcolor="#eff6ee">
		<?php if($num_3!="0") { ?>
			<a href="report_borrow_view.php?for_month=03&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_3 ) ; ?></a>
		<?php } else { echo "-"; } ?>
	</td>
	...
	<td class="center font_brown" bgcolor="#eef5f6">
		<?php if($num_4!="0") { ?>
			<a href="report_borrow_view.php?for_month=04&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_4 ) ; ?></a>
		<?php } else { echo "-"; } ?>
	</td>
	<td class="center font_brown" bgcolor="#eef5f6">
		<?php if($num_5!="0") { ?>
			<a href="report_borrow_view.php?for_month=05&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_5 ) ; ?></a>
		<?php } else { echo "-"; } ?>
	</td>
	<td class="center font_brown" bgcolor="#eef5f6">
		<?php if($num_6!="0") { ?>
			<a href="report_borrow_view.php?for_month=06&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_6 ) ; ?></a>
		<?php } else { echo "-"; } ?>
	</td>
	...
	<!-- period 4 -->
		<td class="center font_brown" bgcolor="#eff6ee">
			<?php if($num_7!="0") { ?>
				<a href="report_borrow_view.php?for_month=07&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_7 ) ; ?></a>
			<?php } else { echo "-"; } ?>
		</td>
		<td class="center font_brown" bgcolor="#eff6ee">
			<?php if($num_8!="0") { ?>
				<a href="report_borrow_view.php?for_month=08&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_8 ) ; ?></a>
			<?php } else { echo "-"; } ?>
		</td>
		<td class="center font_brown" bgcolor="#eff6ee">
			<?php if($num_9!="0") { ?>
				<a href="report_borrow_view.php?for_month=09&choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $num_9 ) ; ?></a>
			<?php } else { echo "-"; } ?>
		</td>

		<!-- sum -->
		<td class="center font_brown" bgcolor="#fcfaf2"><?php if($var_num!="0") { ?><a href="report_borrow_view.php?choose_year=<?php echo $choose_year;?>&id_category=<?php echo $id_cate;?>" target="_blank"><?php echo number_format( $var_num ) ; ?></a><?php } else { echo "-"; }?></td>
                                          </tr>
		<?php
