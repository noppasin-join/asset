...
?>
 ...
 <form name="frmMain" id="popup-validation" method="post" action="dup_data.php" enctype="multipart/form-data">
      ...
      <div class="page-content">
        <div class="row">
          ...
          <div class="col-xs-12">
                    ...
                    <div class="row">
                      <div class="col-xs-7 col-sm-4">
                        <div class="input-group"> <span class="input-group-addon" style="background-color:#eeeeee;"><i class="ace-icon fa fa-bars"></i></span>
                          ...
                          placeholder="เลขครุภัณฑ์ ส่วนพัสดุ" autocomplete="off" onKeyPress="checknumber()" value="<?php echo $barcode2; ?>">
                        </div>
                        ...
                        <div class="input-group"> <span class="input-group-addon" style="background-color:#eeeeee;"><i class="ace-icon fa fa-bars"></i></span>
                          ...
                          placeholder="เลขครุภัณฑ์ ศูนย์บรรณสารฯ" autocomplete="off" onKeyPress="checknumber()" value="<?php echo $barcode1; ?>">
                        </div>
												<div class="row" style="padding:3px;"> </div>
                      </div>
											<div class="col-xs-7 col-sm-4">
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-4 font_brown" style="padding-top: 12px;">
												<label class="input-group">
													<a  href="file_att/<?php echo $year_budget;?>/<?php echo $file_att;?>" target="_blank"> <i class="ace-icon fa fa-tag bigger-130"></i> ไฟล์แนบ</a>&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="row">
              <div class="col-xs-12">
                <button type="submit" class="btn bg-olive"><i class="ace-icon fa fa-floppy-o bigger-130"></i> คัดลอกข้อมูล</button>
              </div>
            </div>
          </div>
          <!-- /.row -->
