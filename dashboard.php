...
<?php if($choose_year=="" && $choose_cate=="" && $choose_status=="") { ?>
<?php
$q_2540 = "SELECT * from  data_lda where year_budget='2540'";$qr_2540=ams_query($link,$q_2540);$n2540=mysqli_num_rows($qr_2540);
$q_2542 = "SELECT * from  data_lda where year_budget='2542'";$qr_2542=ams_query($link,$q_2542);$n2542=mysqli_num_rows($qr_2542);
$q_2543 = "SELECT * from  data_lda where year_budget='2543'";$qr_2543=ams_query($link,$q_2543);$n2543=mysqli_num_rows($qr_2543);
$q_2544 = "SELECT * from  data_lda where year_budget='2544'";$qr_2544=ams_query($link,$q_2544);$n2544=mysqli_num_rows($qr_2544);
$q_2545 = "SELECT * from  data_lda where year_budget='2545'";$qr_2545=ams_query($link,$q_2545);$n2545=mysqli_num_rows($qr_2545);
$q_2546 = "SELECT * from  data_lda where year_budget='2546'";$qr_2546=ams_query($link,$q_2546);$n2546=mysqli_num_rows($qr_2546);
$q_2547 = "SELECT * from  data_lda where year_budget='2547'";$qr_2547=ams_query($link,$q_2547);$n2547=mysqli_num_rows($qr_2547);
$q_2548 = "SELECT * from  data_lda where year_budget='2548'";$qr_2548=ams_query($link,$q_2548);$n2548=mysqli_num_rows($qr_2548);
$q_2549 = "SELECT * from  data_lda where year_budget='2549'";$qr_2549=ams_query($link,$q_2549);$n2549=mysqli_num_rows($qr_2549);
$q_2550 = "SELECT * from  data_lda where year_budget='2550'";$qr_2550=ams_query($link,$q_2550);$n2550=mysqli_num_rows($qr_2550);
$q_2551 = "SELECT * from  data_lda where year_budget='2551'";$qr_2551=ams_query($link,$q_2551);$n2551=mysqli_num_rows($qr_2551);
$q_2552 = "SELECT * from  data_lda where year_budget='2552'";$qr_2552=ams_query($link,$q_2552);$n2552=mysqli_num_rows($qr_2552);
$q_2553 = "SELECT * from  data_lda where year_budget='2553'";$qr_2553=ams_query($link,$q_2553);$n2553=mysqli_num_rows($qr_2553);
$q_2554 = "SELECT * from  data_lda where year_budget='2554'";$qr_2554=ams_query($link,$q_2554);$n2554=mysqli_num_rows($qr_2554);
$q_2555 = "SELECT * from  data_lda where year_budget='2555'";$qr_2555=ams_query($link,$q_2555);$n2555=mysqli_num_rows($qr_2555);
$q_2556 = "SELECT * from  data_lda where year_budget='2556'";$qr_2556=ams_query($link,$q_2556);$n2556=mysqli_num_rows($qr_2556);
$q_2557 = "SELECT * from  data_lda where year_budget='2557'";$qr_2557=ams_query($link,$q_2557);$n2557=mysqli_num_rows($qr_2557);
$q_2558 = "SELECT * from  data_lda where year_budget='2558'";$qr_2558=ams_query($link,$q_2558);$n2558=mysqli_num_rows($qr_2558);
$q_2559 = "SELECT * from  data_lda where year_budget='2559'";$qr_2559=ams_query($link,$q_2559);$n2559=mysqli_num_rows($qr_2559);
$q_2560 = "SELECT * from  data_lda where year_budget='2560'";$qr_2560=ams_query($link,$q_2560);$n2560=mysqli_num_rows($qr_2560);
$q_2561 = "SELECT * from  data_lda where year_budget='2561'";$qr_2561=ams_query($link,$q_2561);$n2561=mysqli_num_rows($qr_2561);
$q_2562 = "SELECT * from  data_lda where year_budget='2562'";$qr_2562=ams_query($link,$q_2562);$n2562=mysqli_num_rows($qr_2562);
$q_2563 = "SELECT * from  data_lda where year_budget='2563'";$qr_2563=ams_query($link,$q_2563);$n2563=mysqli_num_rows($qr_2563);
$q_2564 = "SELECT * from  data_lda where year_budget='2564'";$qr_2564=ams_query($link,$q_2564);$n2564=mysqli_num_rows($qr_2564);
$q_2565 = "SELECT * from  data_lda where year_budget='2565'";$qr_2565=ams_query($link,$q_2565);$n2565=mysqli_num_rows($qr_2565);
$q_2566 = "SELECT * from  data_lda where year_budget='2566'";$qr_2566=ams_query($link,$q_2566);$n2566=mysqli_num_rows($qr_2566);
$q_2567 = "SELECT * from  data_lda where year_budget='2567'";$qr_2567=ams_query($link,$q_2567);$n2567=mysqli_num_rows($qr_2567);
$q_2568 = "SELECT * from  data_lda where year_budget='2568'";$qr_2568=ams_query($link,$q_2568);$n2568=mysqli_num_rows($qr_2568);
?>
...
function page_navigator2($before_p2,$plus_p2,$total2,$total_p2,$chk_page2,$choose_year,$choose_status,$choose_cate){
...
$lt_page=$total_p2-4;
if($chk_page2>0){
echo "<a  href='?s_page2=$pPrev&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&choose_year=$choose_year&&choose_cate=$choose_cate&&choose_status=$choose_status&&g=1' class='naviPN'><<</a>";
}
if($total_p2>=11){
if($chk_page2>=4){
echo "<a $nClass href='?s_page2=0&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&choose_year=$choose_year&&choose_cate=$choose_cate&&choose_status=$choose_status&&g=1'>1</a><a class='SpaceC'>. . .</a>";
}
if($chk_page2<4){
for($i=0;$i<$total_p2;$i++){
$nClass=($chk_page2==$i)?"class='selectPage'":"";
if($i<=4){
echo "<a $nClass href='?s_page2=$i&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&choose_year=$choose_year&&choose_cate=$choose_cate&&choose_status=$choose_status&&g=1'>".intval($i+1)."</a> ";
}
if($i==$total_p2-1 ){
echo "<a class='SpaceC'>. . .</a><a $nClass href='?s_page2=$i&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&choose_year=$choose_year&&choose_cate=$choose_cate&&choose_status=$choose_status&&g=1'>".intval($i+1)."</a> ";
}
}
}
...
echo "<a $nClass href='?s_page2=".intval($st_page+$i)."&&radiobutton=2&&choose_year=$choose_year&&choose_cate=$choose_cate&&choose_status=$choose_status&&g=1'>".intval($st_page+$i+1)."</a> ";
}
for($i=0;$i<$total_p2;$i++){
if($i==$total_p2-1 ){
$nClass=($chk_page2==$i)?"class='selectPage'":"";
...
echo "<a $nClass href='?s_page2=".intval($lt_page+$i-1)."&&radiobutton=2&&choose_year=$choose_year&&choose_cate=$choose_cate&&choose_status=$choose_status&&g=1'>".intval($lt_page+$i)."</a> ";
}
}
}else{
for($i=0;$i<$total_p2;$i++){
$nClass=($chk_page2==$i)?"class='selectPage'":"";
echo "<a href='?s_page2=$i&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&choose_year=$choose_year&&choose_cate=$choose_cate&&choose_status=$choose_status&&g=1' $nClass  >".intval($i+1)."</a> ";
}
}
if($chk_page2<$total_p2-1){
echo "<a href='?s_page2=$pNext&urlquery_str2=".$urlquery_str2."&&radiobutton=2&&choose_year=$choose_year&&choose_cate=$choose_cate&&choose_status=$choose_status&&g=1'  class='naviPN'>>></a>";
}
}
?>
</head>
...
if($choose_year=="") {
		...
		} elseif($choose_cate!="" && $choose_status=="") {
			$q = ams_sql("SELECT * from  data_lda where id_category=?", ["$choose_cate"]);
		} elseif($choose_cate=="" && $choose_status!="") {
			$q = ams_sql("SELECT * from  data_lda where lda_status=?", ["$choose_status"]);
		} elseif($choose_cate!="" && $choose_status="") {
			$q = ams_sql("SELECT * from  data_lda where lda_status=? and id_category=?", ["$choose_status", "$choose_cate"]);
		}
} else {
		if($choose_cate=="" && $choose_status=="") {
			...
			$q = ams_sql("SELECT * from  data_lda where lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
		} elseif($choose_cate=="" && $choose_status!="") {
			$q = ams_sql("SELECT * from  data_lda where lda_status=? and id_category=? and year_budget=?", ["$choose_status", "$choose_cate", "$choose_year"]);
		}
}
	...
	<div class="main-container2">
		<div class="pd-ltr-20 xs-pd-20-10">
						...
						<div class="col-md-6 col-sm-12 text-right">
							...
							<div class="pull-left">
								<select class="selectpicker form-control" data-style="btn-outline-secondary" name="choose_year" onChange="submit();">
									...
									<?php
									$sql_year_choose = "SELECT * from  budget order by year_budget desc ";
							...
							<?php } else { ?>
								<select class="selectpicker form-control" data-style="btn-outline-secondary" name="choose_cate" disabled>
							<?php } ?>
							...
							<div class="pull-left" style="padding-left: 10px;">
							<?php if($choose_cate=="") { ?>
								<select class="selectpicker form-control" data-style="btn-outline-secondary" name="choose_status" onChange="submit();">
							<?php } else { ?>
								<select class="selectpicker form-control" data-style="btn-outline-secondary" name="choose_status" disabled>
							<?php } ?>


								<?php if($choose_status=="") { ?><option value="" selected>-- เลือก --</option><?php } else { ?><option value="">-- เลือก --</option><?php } ?>
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo number_format($total2); ?></h3>
                <p>รายการ</p>
              </div>
              <div class="icon">
...
<?php if($choose_status!="" || $choose_cate!="") { ?>
				<div class="card-box col-md-12 col-sm-12">
					<div class="pd-20 col-md-12 col-sm-12">

						<?php if($total2!=0) { ?>
								<div class="pull-right pagination9"  style="font-size:14px;">
									<li>
										<?php page_navigator2($before_p2,$plus_p2,$total2,$total_p2,$chk_page2,$choose_year,$choose_status,$choose_cate); ?>
									</li>
								</div>
						<?php } ?>
					</div>
...
?>
<tr>
	<td style="font-size: 14px!important;" style="padding-left: 25px;"><?php echo ($chk_page2*$e_page)+$i;?></td>
	<td style="font-size: 14px!important;"><?php echo $rs['lda_list'];?></td>
	<td style="font-size: 14px!important;">
		<?php if($rs['lda_status']=="1") { ?>ใช้งานปกติ<?php } ?>
		<?php if($rs['lda_status']=="2") { ?>ชำรุด<?php } ?>
		<?php if($rs['lda_status']=="3") { ?>สูญหาย<?php } ?>
		<?php if($rs['lda_status']=="4") { ?>โอนย้าย/บริจาค<?php } ?>
		<?php if($rs['lda_status']=="5") { ?>จำหน่ายออก<?php } ?>
		<?php if($rs['lda_status']=="6") { ?>ส่งซ่อม<?php } ?>
		<?php if($rs['lda_status']=="7") { ?>สภาพปกติ ไม่จำเป็นต้องใช้งาน<?php } ?>
		<?php if($rs['lda_status']=="8") { ?>รอจำหน่ายออก<?php } ?>
	</td>
	<td style="font-size: 14px!important;">
		<?php
		$sql_lc = ams_sql("SELECT * from  data_location where id=? ", ["$rs[id_location]"]);
		$qr_lc=ams_query($link,$sql_lc) or die ("Error Location");
		$rs_lc=mysqli_fetch_array($qr_lc);
		$name_location=$rs_lc['name_location'];
		?>
...
<?php $i2++; $i++; } ?>
<?php } else { ?>
<td colspan="4" class="font_t15 center">ไม่มีข้อมูล</td>
<?php } ?>
...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30">
	<div class="pd-20 card-box height-100-p">
		<div class="progress-box text-center">
			<div class="x_panel">
				<div class="x_title">
					<h5>จำนวนรายการ ปีงบประมาณทั้งหมด</h5>
					<div class="clearfix"></div>
				</div>
				<div class="x_content">
...
<div style="padding: 5px;"> </div>
	...
	<script src="admin/assets3/js/bootstrap.min.js"></script>
	<script src="admin/assets3/js/ace-elements.min.js"></script>

	<!-- ace scripts -->

	<script src="admin/assets3/js/jquery-ui.custom.min.js"></script>
	<script src="admin/assets3/js/jquery.ui.touch-punch.min.js"></script>
	<script src="admin/assets3/js/jquery.easypiechart.min.js"></script>
	<script src="admin/assets3/js/jquery.sparkline.min.js"></script>
	<script src="admin/assets3/js/jquery.flot.min.js"></script>
	<script src="admin/assets3/js/jquery.flot.pie.min.js"></script>
	<script src="admin/assets3/js/jquery.flot.resize.min.js"></script>



	<script src="admin/vendors2/echarts/dist/echarts.min.js"></script>
	<script src="admin/vendors2/echarts/map/js/world.js"></script>


	<!-- morris.js -->
	<script src="admin/vendors2/raphael/raphael.min.js"></script>
	<script src="admin/vendors2/morris.js/morris.min.js"></script>
	...
	<script src="src/scripts/jquery.min.js"></script>
			...
			if($choose_year=="") {
							...
							if($choose_cate=="" && $choose_status=="") {
								...
								$sql_6 = "SELECT * from data_lda where id_category='6' ";
								$qr_6=ams_query($link,$sql_6) or die ("Error 6"); $po_6=mysqli_num_rows($qr_6);
								$sql_7 = "SELECT * from data_lda where id_category='7' ";
								$qr_7=ams_query($link,$sql_7) or die ("Error 7"); $po_7=mysqli_num_rows($qr_7);
								$sql_8 = "SELECT * from data_lda where id_category='8' ";
								$qr_8=ams_query($link,$sql_8) or die ("Error 8"); $po_8=mysqli_num_rows($qr_8);
								$sql_9 = "SELECT * from data_lda where id_category='9' ";
								$qr_9=ams_query($link,$sql_9) or die ("Error 9"); $po_9=mysqli_num_rows($qr_9);

								$status_st_1 = "SELECT * from data_lda where lda_status='1'"; $qr_st_1=ams_query($link,$status_st_1) or die ("Error 1");
								$status_1=mysqli_num_rows($qr_st_1);
								$status_st_2 = "SELECT * from data_lda where lda_status='2'"; $qr_st_2=ams_query($link,$status_st_2) or die ("Error 2");
								$status_2=mysqli_num_rows($qr_st_2);
								$status_st_3 = "SELECT * from data_lda where lda_status='3'"; $qr_st_3=ams_query($link,$status_st_3) or die ("Error 3");
								$status_3=mysqli_num_rows($qr_st_3);
								$status_st_4 = "SELECT * from data_lda where lda_status='4'"; $qr_st_4=ams_query($link,$status_st_4) or die ("Error 4");
								$status_4=mysqli_num_rows($qr_st_4);
								$status_st_5 = "SELECT * from data_lda where lda_status='5'"; $qr_st_5=ams_query($link,$status_st_5) or die ("Error 5");
								$status_5=mysqli_num_rows($qr_st_5);
								$status_st_6 = "SELECT * from data_lda where lda_status='6'"; $qr_st_6=ams_query($link,$status_st_6) or die ("Error 6");
								$status_6=mysqli_num_rows($qr_st_6);
								$status_st_7 = "SELECT * from data_lda where lda_status='7'"; $qr_st_7=ams_query($link,$status_st_7) or die ("Error 7");
								$status_7=mysqli_num_rows($qr_st_7);
								$status_st_8 = "SELECT * from data_lda where lda_status='8'"; $qr_st_8=ams_query($link,$status_st_8) or die ("Error 8");
								$status_8=mysqli_num_rows($qr_st_8);

							} elseif($choose_cate!="" && $choose_status=="") {
								if($choose_cate=="1") {
								$sql_1 = ams_sql("SELECT * from data_lda where id_category=? ", ["$choose_cate"]);
								$qr_1=ams_query($link,$sql_1) or die ("Error 1"); $po_1=mysqli_num_rows($qr_1);
								$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
							} elseif($choose_cate=="2") {
								$sql_2 = ams_sql("SELECT * from data_lda where id_category=? ", ["$choose_cate"]);
								$qr_2=ams_query($link,$sql_2) or die ("Error 2"); $po_2=mysqli_num_rows($qr_2);
								$po_1=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
							} elseif($choose_cate=="3") {
								$sql_3 = ams_sql("SELECT * from data_lda where id_category=? ", ["$choose_cate"]);
								$qr_3=ams_query($link,$sql_3) or die ("Error 3"); $po_3=mysqli_num_rows($qr_3);
								$po_1=0;$po_2=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
							} elseif($choose_cate=="4") {
								$sql_4 = ams_sql("SELECT * from data_lda where id_category=? ", ["$choose_cate"]);
								$qr_4=ams_query($link,$sql_4) or die ("Error 4"); $po_4=mysqli_num_rows($qr_4);
								$po_1=0;$po_2=0;$po_3=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
							} elseif($choose_cate=="5") {
								$sql_5 = ams_sql("SELECT * from data_lda where id_category=? ", ["$choose_cate"]);
								$qr_5=ams_query($link,$sql_5) or die ("Error 5"); $po_5=mysqli_num_rows($qr_5);
								$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
							} elseif($choose_cate=="6") {
								$sql_6 = ams_sql("SELECT * from data_lda where id_category=? ", ["$choose_cate"]);
								$qr_6=ams_query($link,$sql_6) or die ("Error 6"); $po_6=mysqli_num_rows($qr_6);
								$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_7=0;$po_8=0;$po_9=0;
							} elseif($choose_cate=="7") {
								$sql_7 = ams_sql("SELECT * from data_lda where id_category=? ", ["$choose_cate"]);
								$qr_7=ams_query($link,$sql_7) or die ("Error 7"); $po_7=mysqli_num_rows($qr_7);
								$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_8=0;$po_9=0;
							} elseif($choose_cate=="8") {
								$sql_8 = ams_sql("SELECT * from data_lda where id_category=? ", ["$choose_cate"]);
								$qr_8=ams_query($link,$sql_8) or die ("Error 8"); $po_8=mysqli_num_rows($qr_8);
								$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_9=0;
							} elseif($choose_cate=="9") {
								$sql_9 = ams_sql("SELECT * from data_lda where id_category=? ", ["$choose_cate"]);
								$qr_9=ams_query($link,$sql_9) or die ("Error 9"); $po_9=mysqli_num_rows($qr_9);
								$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;
							}


								$status_st_1 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='1'", ["$choose_cate"]);
								$qr_st_1=ams_query($link,$status_st_1) or die ("Error 1");
								$status_1=mysqli_num_rows($qr_st_1);
								$status_st_2 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='2'", ["$choose_cate"]);
								$qr_st_2=ams_query($link,$status_st_2) or die ("Error 2");
								$status_2=mysqli_num_rows($qr_st_2);
								$status_st_3 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='3'", ["$choose_cate"]);
								$qr_st_3=ams_query($link,$status_st_3) or die ("Error 3");
								$status_3=mysqli_num_rows($qr_st_3);
								$status_st_4 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='4'", ["$choose_cate"]);
								$qr_st_4=ams_query($link,$status_st_4) or die ("Error 4");
								$status_4=mysqli_num_rows($qr_st_4);
								$status_st_5 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='5'", ["$choose_cate"]);
								$qr_st_5=ams_query($link,$status_st_5) or die ("Error 5");
								$status_5=mysqli_num_rows($qr_st_5);
								$status_st_6 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='6'", ["$choose_cate"]);
								$qr_st_6=ams_query($link,$status_st_6) or die ("Error 6");
								$status_6=mysqli_num_rows($qr_st_6);
								$status_st_7 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='7'", ["$choose_cate"]);
								$qr_st_7=ams_query($link,$status_st_7) or die ("Error 7");
								$status_7=mysqli_num_rows($qr_st_7);
								$status_st_8 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='8'", ["$choose_cate"]);
								$qr_st_8=ams_query($link,$status_st_8) or die ("Error 8");
								$status_8=mysqli_num_rows($qr_st_8);

							} elseif($choose_cate=="" && $choose_status!="") {

								$sql_1 = ams_sql("SELECT * from data_lda where id_category='1' and lda_status=? ", ["$choose_status"]);
								$qr_1=ams_query($link,$sql_1) or die ("Error 1"); $po_1=mysqli_num_rows($qr_1);
								$sql_2 = ams_sql("SELECT * from data_lda where id_category='2' and lda_status=?", ["$choose_status"]);
								$qr_2=ams_query($link,$sql_2) or die ("Error 2"); $po_2=mysqli_num_rows($qr_2);
								$sql_3 = ams_sql("SELECT * from data_lda where id_category='3' and lda_status=?", ["$choose_status"]);
								$qr_3=ams_query($link,$sql_3) or die ("Error 3"); $po_3=mysqli_num_rows($qr_3);
								$sql_4 = ams_sql("SELECT * from data_lda where id_category='4' and lda_status=?", ["$choose_status"]);
								$qr_4=ams_query($link,$sql_4) or die ("Error 4"); $po_4=mysqli_num_rows($qr_4);
								$sql_5 = ams_sql("SELECT * from data_lda where id_category='5' and lda_status=?", ["$choose_status"]);
								$qr_5=ams_query($link,$sql_5) or die ("Error 5"); $po_5=mysqli_num_rows($qr_5);
								$sql_6 = ams_sql("SELECT * from data_lda where id_category='6' and lda_status=?", ["$choose_status"]);
								$qr_6=ams_query($link,$sql_6) or die ("Error 6"); $po_6=mysqli_num_rows($qr_6);
								$sql_7 = ams_sql("SELECT * from data_lda where id_category='7' and lda_status=?", ["$choose_status"]);
								$qr_7=ams_query($link,$sql_7) or die ("Error 7"); $po_7=mysqli_num_rows($qr_7);
								$sql_8 = ams_sql("SELECT * from data_lda where id_category='8' and lda_status=?", ["$choose_status"]);
								$qr_8=ams_query($link,$sql_8) or die ("Error 8"); $po_8=mysqli_num_rows($qr_8);
								$sql_9 = ams_sql("SELECT * from data_lda where id_category='9' and lda_status=?", ["$choose_status"]);
								$qr_9=ams_query($link,$sql_9) or die ("Error 9"); $po_9=mysqli_num_rows($qr_9);

								if($choose_status=="1") {
									$status_st_1 = ams_sql("SELECT * from data_lda where lda_status=?", ["$choose_status"]);
									$qr_st_1=ams_query($link,$status_st_1) or die ("Error 1");
									$status_1=mysqli_num_rows($qr_st_1);
									$status_2=0;$status_3=0;$status_4=0;$status_5=0;$status_6=0;$status_7=0;$status_8=0;
								} elseif($choose_status=="2") {
									$status_st_2 = ams_sql("SELECT * from data_lda where lda_status=?", ["$choose_status"]);
									$qr_st_2=ams_query($link,$status_st_2) or die ("Error 2");
									$status_2=mysqli_num_rows($qr_st_2);
									$status_1=0;$status_3=0;$status_4=0;$status_5=0;$status_6=0;$status_7=0;$status_8=0;
								} elseif($choose_status=="3") {
									$status_st_3 = ams_sql("SELECT * from data_lda where lda_status=?", ["$choose_status"]);
									$qr_st_3=ams_query($link,$status_st_3) or die ("Error 3");
									$status_3=mysqli_num_rows($qr_st_3);
									$status_1=0;$status_2=0;$status_4=0;$status_5=0;$status_6=0;$status_7=0;$status_8=0;
								} elseif($choose_status=="4") {
									$status_st_4 = ams_sql("SELECT * from data_lda where lda_status=?", ["$choose_status"]);
									$qr_st_4=ams_query($link,$status_st_4) or die ("Error 4");
									$status_4=mysqli_num_rows($qr_st_4);
									$status_1=0;$status_2=0;$status_3=0;$status_5=0;$status_6=0;$status_7=0;$status_8=0;
								} elseif($choose_status=="5") {
									$status_st_5 = ams_sql("SELECT * from data_lda where lda_status=?", ["$choose_status"]);
									$qr_st_5=ams_query($link,$status_st_5) or die ("Error 5");
									$status_5=mysqli_num_rows($qr_st_5);
									$status_1=0;$status_2=0;$status_3=0;$status_4=0;$status_6=0;$status_7=0;$status_8=0;
								} elseif($choose_status=="6") {
									$status_st_6 = ams_sql("SELECT * from data_lda where lda_status=?", ["$choose_status"]);
									$qr_st_6=ams_query($link,$status_st_6) or die ("Error 6");
									$status_6=mysqli_num_rows($qr_st_6);
									$status_1=0;$status_2=0;$status_3=0;$status_4=0;$status_5=0;$status_7=0;$status_8=0;
								} elseif($choose_status=="7") {
									$status_st_7 = ams_sql("SELECT * from data_lda where lda_status=?", ["$choose_status"]);
									$qr_st_7=ams_query($link,$status_st_7) or die ("Error 7");
									$status_7=mysqli_num_rows($qr_st_7);
									$status_1=0;$status_2=0;$status_3=0;$status_4=0;$status_5=0;$status_6=0;$status_8=0;
								} elseif($choose_status=="8") {
									$status_st_8 = ams_sql("SELECT * from data_lda where id_category=?", ["$choose_cate"]);
									$qr_st_8=ams_query($link,$status_st_8) or die ("Error 8");
									$status_8=mysqli_num_rows($qr_st_8);
									$status_1=0;$status_2=0;$status_3=0;$status_4=0;$status_5=0;$status_6=0;$status_7=0;
								}

							} elseif($choose_cate!="" && $choose_status!="") {
								$status_st_1 = ams_sql("SELECT * from data_lda where lda_status='1' and lda_status=? and id_category=?", ["$choose_status", "$choose_cate"]);
								$qr_st_1=ams_query($link,$status_st_1) or die ("Error 1");
								$status_1=mysqli_num_rows($qr_st_1);
								$status_st_2 = ams_sql("SELECT * from data_lda where lda_status='2' and lda_status=? and id_category=?", ["$choose_status", "$choose_cate"]);
								$qr_st_2=ams_query($link,$status_st_2) or die ("Error 2");
								$status_2=mysqli_num_rows($qr_st_2);
								$status_st_3 = ams_sql("SELECT * from data_lda where lda_status='3' and lda_status=? and id_category=?", ["$choose_status", "$choose_cate"]);
								$qr_st_3=ams_query($link,$status_st_3) or die ("Error 3");
								$status_3=mysqli_num_rows($qr_st_3);
								$status_st_4 = ams_sql("SELECT * from data_lda where lda_status='4' and lda_status=? and id_category=?", ["$choose_status", "$choose_cate"]);
								$qr_st_4=ams_query($link,$status_st_4) or die ("Error 4");
								$status_4=mysqli_num_rows($qr_st_4);
								$status_st_5 = ams_sql("SELECT * from data_lda where lda_status='5' and lda_status=? and id_category=?", ["$choose_status", "$choose_cate"]);
								$qr_st_5=ams_query($link,$status_st_5) or die ("Error 5");
								$status_5=mysqli_num_rows($qr_st_5);
								$status_st_6 = ams_sql("SELECT * from data_lda where lda_status='6' and lda_status=? and id_category=?", ["$choose_status", "$choose_cate"]);
								$qr_st_6=ams_query($link,$status_st_6) or die ("Error 6");
								$status_6=mysqli_num_rows($qr_st_6);
								$status_st_7 = ams_sql("SELECT * from data_lda where lda_status='7' and lda_status=? and id_category=?", ["$choose_status", "$choose_cate"]);
								$qr_st_7=ams_query($link,$status_st_7) or die ("Error 7");
								$status_7=mysqli_num_rows($qr_st_7);
								$status_st_8 = ams_sql("SELECT * from data_lda where lda_status='8' and id_category=? and id_category=?", ["$choose_cate", "$choose_cate"]);
								$qr_st_8=ams_query($link,$status_st_8) or die ("Error 8");
								$status_8=mysqli_num_rows($qr_st_8);
							}
								...
								if($choose_cate=="" && $choose_status=="") {
									$sql_1 = ams_sql("SELECT * from data_lda where id_category='1' and year_budget=? ", ["$choose_year"]);
									$qr_1=ams_query($link,$sql_1) or die ("Error 1"); $po_1=mysqli_num_rows($qr_1);
									$sql_2 = ams_sql("SELECT * from data_lda where id_category='2' and year_budget=?", ["$choose_year"]);
									$qr_2=ams_query($link,$sql_2) or die ("Error 2"); $po_2=mysqli_num_rows($qr_2);
									$sql_3 = ams_sql("SELECT * from data_lda where id_category='3' and year_budget=?", ["$choose_year"]);
									$qr_3=ams_query($link,$sql_3) or die ("Error 3"); $po_3=mysqli_num_rows($qr_3);
									$sql_4 = ams_sql("SELECT * from data_lda where id_category='4' and year_budget=?", ["$choose_year"]);
									$qr_4=ams_query($link,$sql_4) or die ("Error 4"); $po_4=mysqli_num_rows($qr_4);
									$sql_5 = ams_sql("SELECT * from data_lda where id_category='5' and year_budget=?", ["$choose_year"]);
									$qr_5=ams_query($link,$sql_5) or die ("Error 5"); $po_5=mysqli_num_rows($qr_5);
									$sql_6 = ams_sql("SELECT * from data_lda where id_category='6' and year_budget=?", ["$choose_year"]);
									$qr_6=ams_query($link,$sql_6) or die ("Error 6"); $po_6=mysqli_num_rows($qr_6);
									$sql_7 = ams_sql("SELECT * from data_lda where id_category='7' and year_budget=?", ["$choose_year"]);
									$qr_7=ams_query($link,$sql_7) or die ("Error 7"); $po_7=mysqli_num_rows($qr_7);
									$sql_8 = ams_sql("SELECT * from data_lda where id_category='8' and year_budget=?", ["$choose_year"]);
									$qr_8=ams_query($link,$sql_8) or die ("Error 8"); $po_8=mysqli_num_rows($qr_8);
									$sql_9 = ams_sql("SELECT * from data_lda where id_category='9' and year_budget=?", ["$choose_year"]);
									$qr_9=ams_query($link,$sql_9) or die ("Error 9"); $po_9=mysqli_num_rows($qr_9);

									$status_st_1 = ams_sql("SELECT * from data_lda where lda_status='1' and year_budget=?", ["$choose_year"]); $qr_st_1=ams_query($link,$status_st_1) or die ("Error 1");
									$status_1=mysqli_num_rows($qr_st_1);
									$status_st_2 = ams_sql("SELECT * from data_lda where lda_status='2' and year_budget=?", ["$choose_year"]); $qr_st_2=ams_query($link,$status_st_2) or die ("Error 2");
									$status_2=mysqli_num_rows($qr_st_2);
									$status_st_3 = ams_sql("SELECT * from data_lda where lda_status='3' and year_budget=?", ["$choose_year"]); $qr_st_3=ams_query($link,$status_st_3) or die ("Error 3");
									$status_3=mysqli_num_rows($qr_st_3);
									$status_st_4 = ams_sql("SELECT * from data_lda where lda_status='4' and year_budget=?", ["$choose_year"]); $qr_st_4=ams_query($link,$status_st_4) or die ("Error 4");
									$status_4=mysqli_num_rows($qr_st_4);
									$status_st_5 = ams_sql("SELECT * from data_lda where lda_status='5' and year_budget=?", ["$choose_year"]); $qr_st_5=ams_query($link,$status_st_5) or die ("Error 5");
									$status_5=mysqli_num_rows($qr_st_5);
									$status_st_6 = ams_sql("SELECT * from data_lda where lda_status='6' and year_budget=?", ["$choose_year"]); $qr_st_6=ams_query($link,$status_st_6) or die ("Error 6");
									$status_6=mysqli_num_rows($qr_st_6);
									$status_st_7 = ams_sql("SELECT * from data_lda where lda_status='7' and year_budget=?", ["$choose_year"]); $qr_st_7=ams_query($link,$status_st_7) or die ("Error 7");
									$status_7=mysqli_num_rows($qr_st_7);
									$status_st_8 = ams_sql("SELECT * from data_lda where lda_status='8' and year_budget=?", ["$choose_year"]); $qr_st_8=ams_query($link,$status_st_8) or die ("Error 8");
									$status_8=mysqli_num_rows($qr_st_8);

								} elseif($choose_cate!="" && $choose_status=="") {
									if($choose_cate=="1") {
									$sql_1 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=? ", ["$choose_cate", "$choose_year"]);
									$qr_1=ams_query($link,$sql_1) or die ("Error 1"); $po_1=mysqli_num_rows($qr_1);
									$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
								} elseif($choose_cate=="2") {
									$sql_2 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=? ", ["$choose_cate", "$choose_year"]);
									$qr_2=ams_query($link,$sql_2) or die ("Error 2"); $po_2=mysqli_num_rows($qr_2);
									$po_1=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
								} elseif($choose_cate=="3") {
									$sql_3 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=? ", ["$choose_cate", "$choose_year"]);
									$qr_3=ams_query($link,$sql_3) or die ("Error 3"); $po_3=mysqli_num_rows($qr_3);
									$po_1=0;$po_2=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
								} elseif($choose_cate=="4") {
									$sql_4 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=? ", ["$choose_cate", "$choose_year"]);
									$qr_4=ams_query($link,$sql_4) or die ("Error 4"); $po_4=mysqli_num_rows($qr_4);
									$po_1=0;$po_2=0;$po_3=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
								} elseif($choose_cate=="5") {
									$sql_5 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=? ", ["$choose_cate", "$choose_year"]);
									$qr_5=ams_query($link,$sql_5) or die ("Error 5"); $po_5=mysqli_num_rows($qr_5);
									$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_6=0;$po_7=0;$po_8=0;$po_9=0;
								} elseif($choose_cate=="6") {
									$sql_6 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=? ", ["$choose_cate", "$choose_year"]);
									$qr_6=ams_query($link,$sql_6) or die ("Error 6"); $po_6=mysqli_num_rows($qr_6);
									$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_7=0;$po_8=0;$po_9=0;
								} elseif($choose_cate=="7") {
									$sql_7 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=? ", ["$choose_cate", "$choose_year"]);
									$qr_7=ams_query($link,$sql_7) or die ("Error 7"); $po_7=mysqli_num_rows($qr_7);
									$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_8=0;$po_9=0;
								} elseif($choose_cate=="8") {
									$sql_8 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=? ", ["$choose_cate", "$choose_year"]);
									$qr_8=ams_query($link,$sql_8) or die ("Error 8"); $po_8=mysqli_num_rows($qr_8);
									$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_9=0;
								} elseif($choose_cate=="9") {
									$sql_9 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=? ", ["$choose_cate", "$choose_year"]);
									$qr_9=ams_query($link,$sql_9) or die ("Error 9"); $po_9=mysqli_num_rows($qr_9);
									$po_1=0;$po_2=0;$po_3=0;$po_4=0;$po_5=0;$po_6=0;$po_7=0;$po_8=0;
								}


									$status_st_1 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='1' and year_budget=?", ["$choose_cate", "$choose_year"]);
									$qr_st_1=ams_query($link,$status_st_1) or die ("Error 1");
									$status_1=mysqli_num_rows($qr_st_1);
									$status_st_2 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='2' and year_budget=?", ["$choose_cate", "$choose_year"]);
									$qr_st_2=ams_query($link,$status_st_2) or die ("Error 2");
									$status_2=mysqli_num_rows($qr_st_2);
									$status_st_3 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='3' and year_budget=?", ["$choose_cate", "$choose_year"]);
									$qr_st_3=ams_query($link,$status_st_3) or die ("Error 3");
									$status_3=mysqli_num_rows($qr_st_3);
									$status_st_4 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='4' and year_budget=?", ["$choose_cate", "$choose_year"]);
									$qr_st_4=ams_query($link,$status_st_4) or die ("Error 4");
									$status_4=mysqli_num_rows($qr_st_4);
									$status_st_5 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='5' and year_budget=?", ["$choose_cate", "$choose_year"]);
									$qr_st_5=ams_query($link,$status_st_5) or die ("Error 5");
									$status_5=mysqli_num_rows($qr_st_5);
									$status_st_6 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='6' and year_budget=?", ["$choose_cate", "$choose_year"]);
									$qr_st_6=ams_query($link,$status_st_6) or die ("Error 6");
									$status_6=mysqli_num_rows($qr_st_6);
									$status_st_7 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='7' and year_budget=?", ["$choose_cate", "$choose_year"]);
									$qr_st_7=ams_query($link,$status_st_7) or die ("Error 7");
									$status_7=mysqli_num_rows($qr_st_7);
									$status_st_8 = ams_sql("SELECT * from data_lda where id_category=? and lda_status='8' and year_budget=?", ["$choose_cate", "$choose_year"]);
									$qr_st_8=ams_query($link,$status_st_8) or die ("Error 8");
									$status_8=mysqli_num_rows($qr_st_8);

								} elseif($choose_cate=="" && $choose_status!="") {

									$sql_1 = ams_sql("SELECT * from data_lda where id_category='1' and lda_status=? and year_budget=? ", ["$choose_status", "$choose_year"]);
									$qr_1=ams_query($link,$sql_1) or die ("Error 1"); $po_1=mysqli_num_rows($qr_1);
									$sql_2 = ams_sql("SELECT * from data_lda where id_category='2' and lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
									$qr_2=ams_query($link,$sql_2) or die ("Error 2"); $po_2=mysqli_num_rows($qr_2);
									$sql_3 = ams_sql("SELECT * from data_lda where id_category='3' and lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
									$qr_3=ams_query($link,$sql_3) or die ("Error 3"); $po_3=mysqli_num_rows($qr_3);
									$sql_4 = ams_sql("SELECT * from data_lda where id_category='4' and lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
									$qr_4=ams_query($link,$sql_4) or die ("Error 4"); $po_4=mysqli_num_rows($qr_4);
									$sql_5 = ams_sql("SELECT * from data_lda where id_category='5' and lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
									$qr_5=ams_query($link,$sql_5) or die ("Error 5"); $po_5=mysqli_num_rows($qr_5);
									$sql_6 = ams_sql("SELECT * from data_lda where id_category='6' and lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
									$qr_6=ams_query($link,$sql_6) or die ("Error 6"); $po_6=mysqli_num_rows($qr_6);
									$sql_7 = ams_sql("SELECT * from data_lda where id_category='7' and lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
									$qr_7=ams_query($link,$sql_7) or die ("Error 7"); $po_7=mysqli_num_rows($qr_7);
									$sql_8 = ams_sql("SELECT * from data_lda where id_category='8' and lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
									$qr_8=ams_query($link,$sql_8) or die ("Error 8"); $po_8=mysqli_num_rows($qr_8);
									$sql_9 = ams_sql("SELECT * from data_lda where id_category='9' and lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
									$qr_9=ams_query($link,$sql_9) or die ("Error 9"); $po_9=mysqli_num_rows($qr_9);

									if($choose_status=="1") {
										$status_st_1 = ams_sql("SELECT * from data_lda where lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
										$qr_st_1=ams_query($link,$status_st_1) or die ("Error 1");
										$status_1=mysqli_num_rows($qr_st_1);
										$status_2=0;$status_3=0;$status_4=0;$status_5=0;$status_6=0;$status_7=0;$status_8=0;
									} elseif($choose_status=="2") {
										$status_st_2 = ams_sql("SELECT * from data_lda where lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
										$qr_st_2=ams_query($link,$status_st_2) or die ("Error 2");
										$status_2=mysqli_num_rows($qr_st_2);
										$status_1=0;$status_3=0;$status_4=0;$status_5=0;$status_6=0;$status_7=0;$status_8=0;
									} elseif($choose_status=="3") {
										$status_st_3 = ams_sql("SELECT * from data_lda where lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
										$qr_st_3=ams_query($link,$status_st_3) or die ("Error 3");
										$status_3=mysqli_num_rows($qr_st_3);
										$status_1=0;$status_2=0;$status_4=0;$status_5=0;$status_6=0;$status_7=0;$status_8=0;
									} elseif($choose_status=="4") {
										$status_st_4 = ams_sql("SELECT * from data_lda where lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
										$qr_st_4=ams_query($link,$status_st_4) or die ("Error 4");
										$status_4=mysqli_num_rows($qr_st_4);
										$status_1=0;$status_2=0;$status_3=0;$status_5=0;$status_6=0;$status_7=0;$status_8=0;
									} elseif($choose_status=="5") {
										$status_st_5 = ams_sql("SELECT * from data_lda where lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
										$qr_st_5=ams_query($link,$status_st_5) or die ("Error 5");
										$status_5=mysqli_num_rows($qr_st_5);
										$status_1=0;$status_2=0;$status_3=0;$status_4=0;$status_6=0;$status_7=0;$status_8=0;
									} elseif($choose_status=="6") {
										$status_st_6 = ams_sql("SELECT * from data_lda where lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
										$qr_st_6=ams_query($link,$status_st_6) or die ("Error 6");
										$status_6=mysqli_num_rows($qr_st_6);
										$status_1=0;$status_2=0;$status_3=0;$status_4=0;$status_5=0;$status_7=0;$status_8=0;
									} elseif($choose_status=="7") {
										$status_st_7 = ams_sql("SELECT * from data_lda where lda_status=? and year_budget=?", ["$choose_status", "$choose_year"]);
										$qr_st_7=ams_query($link,$status_st_7) or die ("Error 7");
										$status_7=mysqli_num_rows($qr_st_7);
										$status_1=0;$status_2=0;$status_3=0;$status_4=0;$status_5=0;$status_6=0;$status_8=0;
									} elseif($choose_status=="8") {
										$status_st_8 = ams_sql("SELECT * from data_lda where id_category=? and year_budget=?", ["$choose_cate", "$choose_year"]);
										$qr_st_8=ams_query($link,$status_st_8) or die ("Error 8");
										$status_8=mysqli_num_rows($qr_st_8);
										$status_1=0;$status_2=0;$status_3=0;$status_4=0;$status_5=0;$status_6=0;$status_7=0;
									}
									...
									$status_st_1 = ams_sql("SELECT * from data_lda where lda_status='1' and lda_status=? and id_category=? and year_budget=?", ["$choose_status", "$choose_cate", "$choose_year"]);
									$qr_st_1=ams_query($link,$status_st_1) or die ("Error 1");
									$status_1=mysqli_num_rows($qr_st_1);
									$status_st_2 = ams_sql("SELECT * from data_lda where lda_status='2' and lda_status=? and id_category=? and year_budget=?", ["$choose_status", "$choose_cate", "$choose_year"]);
									$qr_st_2=ams_query($link,$status_st_2) or die ("Error 2");
									$status_2=mysqli_num_rows($qr_st_2);
									$status_st_3 = ams_sql("SELECT * from data_lda where lda_status='3' and lda_status=? and id_category=? and year_budget=?", ["$choose_status", "$choose_cate", "$choose_year"]);
									$qr_st_3=ams_query($link,$status_st_3) or die ("Error 3");
									$status_3=mysqli_num_rows($qr_st_3);
									$status_st_4 = ams_sql("SELECT * from data_lda where lda_status='4' and lda_status=? and id_category=? and year_budget=?", ["$choose_status", "$choose_cate", "$choose_year"]);
									$qr_st_4=ams_query($link,$status_st_4) or die ("Error 4");
									$status_4=mysqli_num_rows($qr_st_4);
									$status_st_5 = ams_sql("SELECT * from data_lda where lda_status='5' and lda_status=? and id_category=? and year_budget=?", ["$choose_status", "$choose_cate", "$choose_year"]);
									$qr_st_5=ams_query($link,$status_st_5) or die ("Error 5");
									$status_5=mysqli_num_rows($qr_st_5);
									$status_st_6 = ams_sql("SELECT * from data_lda where lda_status='6' and lda_status=? and id_category=? and year_budget=?", ["$choose_status", "$choose_cate", "$choose_year"]);
									$qr_st_6=ams_query($link,$status_st_6) or die ("Error 6");
									$status_6=mysqli_num_rows($qr_st_6);
									$status_st_7 = ams_sql("SELECT * from data_lda where lda_status='7' and lda_status=? and id_category=? and year_budget=?", ["$choose_status", "$choose_cate", "$choose_year"]);
									$qr_st_7=ams_query($link,$status_st_7) or die ("Error 7");
									$status_7=mysqli_num_rows($qr_st_7);
									$status_st_8 = ams_sql("SELECT * from data_lda where lda_status='8' and id_category=? and id_category=? and year_budget=?", ["$choose_cate", "$choose_cate", "$choose_year"]);
									$qr_st_8=ams_query($link,$status_st_8) or die ("Error 8");
									$status_8=mysqli_num_rows($qr_st_8);
								}
			...
			if($status_3=="") { $status_3=="0"; }
			if($status_4=="") { $status_4=="0"; }
			if($status_5=="") { $status_5=="0"; }
			if($status_6=="") { $status_6=="0"; }
			if($status_7=="") { $status_7=="0"; }
			if($status_8=="") { $status_8=="0"; }
...
/* ------- start ------- */
	...
	var a={color:["#26a58a","#34495E","#3498db","#9b59b6","#8abb6f","#6b6b6b","#d75e5e","#dbb95d"],
	...
	legend:{x:"center",y:"bottom",data:["ครุภัณฑ์สำนักงาน","ครุภัณฑ์คอมพิวเตอร์","ครุภัณฑ์โฆษณาและเผยแพร่","ครุภัณฑ์ไฟฟ้าและวิทยุ","ครุภัณฑ์งานบ้านงานครัว","วัสดุไฟฟ้าและวิทยุ","วัสดุคอมพิวเตอร์","วัสดุงานบ้านงานครัว","วัสดุสำนักงาน"]},
	...
	data:[{value:<?php echo $po_1; ?>,name:"ครุภัณฑ์สำนักงาน"},
	{value:<?php echo $po_2; ?>,name:"ครุภัณฑ์คอมพิวเตอร์"},
	{value:<?php echo $po_3; ?>,name:"ครุภัณฑ์โฆษณาและเผยแพร่"},
	{value:<?php echo $po_4; ?>,name:"ครุภัณฑ์ไฟฟ้าและวิทยุ"},
	{value:<?php echo $po_5; ?>,name:"ครุภัณฑ์งานบ้านงานครัว"},
	{value:<?php echo $po_6; ?>,name:"วัสดุไฟฟ้าและวิทยุ"},
	{value:<?php echo $po_7; ?>,name:"วัสดุคอมพิวเตอร์"},
	{value:<?php echo $po_8; ?>,name:"วัสดุงานบ้านงานครัว"},
	{value:<?php echo $po_9; ?>,name:"วัสดุสำนักงาน"}
	...
	if($("#echart_donut").length)
	{
		...
		data:["ใช้งานปกติ","ชำรุด","สูญหาย","โอนย้าย/บริจาค","จำหน่ายออก","ส่งซ่อม","สภาพปกติ ไม่จำเป็นต้องใช้งาน","รอจำหน่ายออก"]},
		...
		data:[{value:<?php echo $status_1; ?>,name:"ใช้งานปกติ"},
		{value:<?php echo $status_2; ?>,name:"ชำรุด"},
		{value:<?php echo $status_3; ?>,name:"สูญหาย"},
		{value:<?php echo $status_3; ?>,name:"โอนย้าย/บริจาค"},
		{value:<?php echo $status_3; ?>,name:"จำหน่ายออก"},
		{value:<?php echo $status_3; ?>,name:"ส่งซ่อม"},
		{value:<?php echo $status_3; ?>,name:"สภาพปกติ ไม่จำเป็นต้องใช้งาน"},
		{value:<?php echo $status_4; ?>,name:"รอจำหน่ายออก"}]}]})
	}
