...
<div class="request-intro"><div><div class="request-eyebrow">LIBRARY · EQUIPMENT REQUEST</div><h1>Equipment Request Form</h1><p>Enter your details and select the equipment you would like to request.</p></div><span class="request-badge"><i class="fa fa-check-circle" aria-hidden="true"></i> No login required</span></div>
